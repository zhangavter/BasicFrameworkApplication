...
package zhang.acfun.com.basicframeworklib.widget.bottomsheet.behavior;
...
public class SpecialBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
        ...
        if (ViewCompat.isNestedScrollingEnabled(view)) {
            ...
            for (int i = 0, count = group.getChildCount(); i < count; i++) {
                ...
                if (group instanceof ViewPager)
                    if (targetView != null && targetView.hashCode() != child.hashCode()) {
                        continue;
                    }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, SpecialBottomSheetBehavior behavior) {
            super(superState);
    ...
    /**
     * A utility function to get the {@link SpecialBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link SpecialBottomSheetBehavior}.
     * @return The {@link SpecialBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> SpecialBottomSheetBehavior<V> from(V view) {
        ...
        return (SpecialBottomSheetBehavior<V>) behavior;
    }
